<template>
  <div class="flex flex-col gap-2">
    <div class="p-4 flex flex-col gap-2 bg-white shadow rounded">
      <AppAvatarImg v-if="user.avatar" class="self-center w-36 h-36 rounded-full object-cover" :src="user.avatar" :alt="`${user.username}'s profile picture`" />
